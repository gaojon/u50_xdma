...
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_0_M_AXI_BYPASS] [get_bd_intf_pins xdma_0/M_AXI_BYPASS] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  connect_bd_net -net pcie_perstn_1 [get_bd_ports pcie_rstn] [get_bd_pins xdma_0/sys_rst_n] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins xdma_0/axi_aclk] [get_bd_pins hbm_0/AXI_00_ACLK] [get_bd_pins smartconnect_1/aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins hbm_0/AXI_01_ACLK] [get_bd_pins system_ila_0/clk] [get_bd_pins smartconnect_2/aclk]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins xdma_0/axi_aresetn] [get_bd_pins hbm_0/AXI_00_ARESET_N] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins hbm_0/AXI_01_ARESET_N] [get_bd_pins system_ila_0/resetn] [get_bd_pins smartconnect_2/aresetn] [get_bd_pins system_ila_1/probe2]
  ...
  assign_bd_address -offset 0x000110000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_BYPASS] [get_bd_addr_segs hbm_0/SAXI_01_RT/HBM_MEM01] -force
